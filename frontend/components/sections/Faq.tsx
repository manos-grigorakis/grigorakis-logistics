...
export default function Faq() {
  ...
  const faqs: { question: string; answer: string }[] = [
    ...
    },
    {
      ...
      answer:
        "Ναι, κατά τη διάρκεια της μεταφοράς είμαστε πάντα διαθέσιμοι τηλεφωνικά. Ο στόλος μας παρακολουθείται σε πραγματικό χρόνο μέσω GPS, οπότε μπορούμε να σας ενημερώνουμε άμεσα για την πορεία και την εκτιμώμενη ώρα παράδοσης.",
    },
  ];
